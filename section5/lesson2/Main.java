...
import section5.lesson2.database.DatabaseClient;
import section5.lesson2.http.HttpClient;
import section5.lesson2.logging.FileLogger;
import section5.lesson2.udp.UdpClient;
    ...
    public static Map<Object, Method> groupExecutors(List<Object> requestExecutors, List<Class<?>> methodParametersType) {
        ...
        for (Object requestExecutor : requestExecutors) {
            ...
            for (Method method : allMethods) {
                if (Arrays.asList(method.getParameterTypes()).equals(methodParametersType)) {
